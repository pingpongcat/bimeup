...
## Current Task: 9.5 RTAO — *additive* alongside XeGTAO; Hybrid picks RTAO, Rasterised still uses XeGTAO. RP.17.6 edge-snap permanently deferred (classical-raster nice-to-have, Stage 9.6 subsumes it via RT).
...
- [ ] 9.5 RTAO — *additive* alongside XeGTAO; Hybrid picks RTAO, Rasterised still uses XeGTAO
  ...
  - [ ] 9.5.b RenderLoop wire RtAoPass (HybridRt per-frame dispatch)
