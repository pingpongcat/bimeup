...
## Current Task: 9.8.b.4 Stage gate — full `ctest` + visual check (raster bit-compatible, Hybrid RT sun lands via composite). RP.17.6 edge-snap permanently deferred (classical-raster nice-to-have, Stage 9.6 subsumes it via RT).
