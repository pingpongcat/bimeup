...
## Current Task: 9.8.d main.cpp + `RenderQualityPanel` glue (folds into 9.10 UI). RP.17.6 edge-snap permanently deferred (classical-raster nice-to-have, Stage 9.6 subsumes it via RT).
