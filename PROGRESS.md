...
## Current Task: RP.18.2 `shadow_transmission.{vert,frag}` + `ShadowTransmissionPipeline` — next session. RP.17.6 edge-snap still deferred; Stage 9 starts after RP.18 closes.
