...
protected:
    static void SetUpTestSuite() {
        ...
        // tonemap.frag: binding 0 = HDR colour, binding 1 = XeGTAO AO (RP.5d).
...
// RP.13b retired binding 2 (fog) and Stage 9 retirement removed binding 2
// again (RT AO). tonemap.frag must NOT declare a binding-3 sampler after
// SSIL retirement (RP.13a). Walks the SPIR-V OpDecorate stream and
...
// Push-constant contract between tonemap.frag and the CPU struct.
// `float exposure` at offset 0 (RP.13b). 4 bytes total.
