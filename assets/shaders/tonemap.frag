...
// RP.13b retired the distance-fog composite — binding 2 (depth pyramid),
// the `computeFog` helper, and the `fogColorEnabled`/`fogStart`/`fogEnd`
// push-constant fields are gone. Only `exposure` remains.
